...
public class SpawnUtility {
   ...
   */
  public static int placeTurrets(GameState move, Coords[] locations) {
    return move.attemptSpawnMultiple(Arrays.asList(locations), Utility.TURRET);
  }

  public static boolean placeTurret(GameState move, Coords location) {
   ...
   */
  public static int placeWalls(GameState move, Coords[] locations) {
    return move.attemptSpawnMultiple(Arrays.asList(locations), Utility.WALL);
  }

  public static boolean placeWall(GameState move, Coords location) {
   ...
   * @param locations the locations to place them
   */
  public static int placeSupports(GameState move, Coords[] locations) {
   ...
   * @return
   */
  public static boolean placeSupport(GameState move, Coords location) {
   ...
   * @param locations the locations to place them
   */
  public static int placeUpgradedSupports(GameState move, Coords[] locations) {
   ...
   */
  public static int applyUpgrades(GameState move, Coords[] locations) {
   ...
   * @return
   */
  public static boolean applyUpgrade(GameState move, Coords location) {
   ...
   */
  public static boolean removeBuilding(GameState move, Coords location) {
   ...
   */
  public static int removeBuildings(GameState move, Coords[] locations) {
   ...
   * @param locations the locations to spawn them
   */
  public static int spawnScouts(GameState move, Coords[] locations) {
   ...
   * @param locations the locations to spawn them
   */
  public static int spawnScouts(GameState move, Coords[] locations, int num) {
    int count = 0;
    for (int i = 0; i < num; i ++) {
  ...
  public static int spawnScouts(GameState move, Coords location, int num) {
   ...
   * @param locations the locations to spawn them
   */
  public static int spawnDemolishers(GameState move, Coords[] locations) {
   ...
   * @param locations the locations to spawn them
   */
  public static int spawnDemolishers(GameState move, Coords[] locations, int num) {
    int count = 0;
    for (int i = 0; i < num; i ++) {
  ...
  public static int spawnDemolishers(GameState move, Coords location, int num) {
   ...
   * @param locations the locations to spawn them
   */
  public static int spawnInterceptors(GameState move, Coords[] locations) {
   ...
   */
  public static int spawnInterceptors(GameState move, Coords[] locations, int num) {
    int count = 0;
    for (int i = 0; i < num; i ++) {
  ...
  public static int spawnInterceptors(GameState move, Coords location, int num) {
   ...
   * @return
   */
  public static int getUnitCost(GameState move, UnitType type, boolean upgrade) {
